...
window.BP_I18N = {
  en: {
    ...
    pub_copy: 'We review the property. It goes live if it meets the requirements. From your panel you see who looks at it, who asks and who books a visit.',
    ...
    ing_err_limite: 'We are sending a lot of codes right now. Wait a few minutes and try again, or continue with Google.',
    ing_codigo_vencido: 'The code expired or does not match. Request a new one with "Resend".',
    ing_err_cerrado: 'Sign-in is closed for now. Write to portal@bairengroup.com.', ing_err_red: 'No connection. Check your internet and try again.',
    ing_crea_desa: 'Create your developer account', ing_crea_desa_sub: 'An email and a code. Then you add the company details, tax ID and your first project.',
    ing_crea_prof: 'Create your agency or broker account', ing_crea_prof_sub: 'An email and a code. Then you add your licence and your first listing.',
    ing_crea_dueno: 'Create your owner account', ing_crea_dueno_sub: 'An email and a code. Then you add your ID, proof of ownership and the property.',
  ...
  pt: {
    ...
    pub_copy: 'Revisamos o imóvel. Ele entra no portal se cumprir os requisitos. Do seu painel você vê quem olha, quem pergunta e quem pede visita.',
    ...
    ing_err_limite: 'Estamos enviando muitos códigos neste momento. Aguarde alguns minutos e tente de novo, ou entre com o Google.',
    ing_codigo_vencido: 'O código venceu ou não confere. Peça um novo em "Reenviar".',
    ing_err_cerrado: 'O acesso está fechado por enquanto. Escreva para portal@bairengroup.com.', ing_err_red: 'Sem conexão. Verifique a internet e tente de novo.',
    ing_crea_desa: 'Crie sua conta de incorporadora', ing_crea_desa_sub: 'Um e-mail e um código. Depois você cadastra os dados da empresa, o CUIT e seu primeiro empreendimento.',
    ing_crea_prof: 'Crie sua conta de imobiliária ou corretor', ing_crea_prof_sub: 'Um e-mail e um código. Depois você cadastra o registro profissional e seu primeiro anúncio.',
    ing_crea_dueno: 'Crie sua conta de proprietário', ing_crea_dueno_sub: 'Um e-mail e um código. Depois você cadastra seu documento, um comprovante de titularidade e o imóvel.',
